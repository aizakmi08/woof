...
function normalizeProduct(raw) {
  ...
  return {
    ...
    availablePackageSizes: Array.isArray(p.availablePackageSizes || p.available_package_sizes) ? p.availablePackageSizes || p.available_package_sizes : [],
    ...
    nutriments: {
      ...
      fiber:
        ...
        null,
      moisture: nutriments.moisture ?? nutriments.moisture_100g ?? null,
      ash: nutriments.ash ?? nutriments.ash_100g ?? null,
      ...
      analysisType: nutriments.analysisType ?? nutriments.analysis_type ?? null,
      basis: nutriments.basis ?? nutriments.valueBasis ?? nutriments.value_basis ?? nutriments.analysisBasis ?? nutriments.analysis_basis ?? null,
    },
    ...
    analysisType: p.analysisType || p.analysis_type || nutriments.analysisType || nutriments.analysis_type || null,
    basis: p.basis || p.valueBasis || p.value_basis || p.analysisBasis || p.analysis_basis || nutriments.basis || null,
    ...
    formulaEvidenceTier: p.formulaEvidenceTier || p.formula_evidence_tier || p.nutritionalInfo?.formula_evidence_tier || p.nutritional_info?.formula_evidence_tier || null,
    formulaVersionProvenance: p.formulaVersionProvenance || p.formula_version_provenance || p.nutritionalInfo?.formula_version_provenance || p.nutritional_info?.formula_version_provenance || null,
    isCompleteFood: p.isCompleteFood ?? p.is_complete_food ?? true,
    catalogExclusionReason: p.catalogExclusionReason || p.catalog_exclusion_reason || "",
