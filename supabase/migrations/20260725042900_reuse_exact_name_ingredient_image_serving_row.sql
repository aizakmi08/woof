-- Product-line display prefixes, conjunction punctuation, and NULL-vs-unknown
-- life stage can differ between staging and serving rows. Exact normalized
-- product name plus exact ingredients and image are the authoritative reuse
-- boundary; brand, species, and food form must also agree.
