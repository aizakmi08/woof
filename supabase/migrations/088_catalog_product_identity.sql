-- Store recipe-level product identity fields so label scans and typed searches
-- can distinguish variants that share a broad brand/product name.
...
CREATE INDEX IF NOT EXISTS idx_product_data_gtin_ready
  ON public.product_data (gtin)
...
CREATE INDEX IF NOT EXISTS idx_product_data_identity_trgm
