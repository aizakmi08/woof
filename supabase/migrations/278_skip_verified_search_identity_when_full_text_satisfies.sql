-- Keep normal verified product searches entirely on indexed full-text/exact
-- candidates. Identity and fuzzy fallbacks now run only when the indexed
-- full-text path cannot produce enough app results.
