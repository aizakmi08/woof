-- Remove the compatibility overload that makes PostgREST unable to choose a
-- single log_product_event RPC candidate, then restore the canonical allowlist.

DROP FUNCTION IF EXISTS public.log_product_event(TEXT, JSONB, TEXT);
