-- Add image_url column to product_data for product photos
ALTER TABLE product_data ADD COLUMN IF NOT EXISTS image_url TEXT;

-- Update save_product_data to accept image_url
