-- Keep the database-side catalog row guard aligned with the official feed
-- importer. Plain "in Broth" wet foods are valid complete-food products; only
-- explicit broth toppers/supplements, or broth rows without core food signals,
-- should be rejected as non-product catalog rows.
...
signals AS (
  SELECT
    ...
    brand,
    (
      product_name ~ '(^| )(food|foods|dry|wet|kibble|pate|pat|entrees?|stews?|loaf|canned|cans?|formula|recipe|meal|dinner|raw|fresh|freezedried|freeze dried|airdried|air dried|dehydrated|puppy|kitten|adult|senior|complete|balanced)( |$)'
