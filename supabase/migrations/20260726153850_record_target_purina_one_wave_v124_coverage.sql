-- Record independently measured coverage after the second reviewed Target
-- Purina ONE package wave. This is a measurement snapshot, not a release claim.
...
INSERT INTO public.catalog_coverage_snapshots (
  ...
  'public-reviewed-major95-target-purina-one-v124:20260726',
  '2026-07-27T00:56:44.040Z',
  '2026-07-27T01:16:14.771Z',
  ARRAY[
  ...
  9732, 6788, 69.75, 86, 38, 2944, 69.75, 69.75,
  true, false, false, false, false,
  jsonb_build_object(
    'searchable_web_evidenced_count', 6788,
    'manufacturer_current_exact_count', 4941,
    'retailer_web_version_count', 1709,
    'web_label_version_count', 138,
    'unresolved_formula_count', 2944,
    'new_exact_source_version_formulas', 12,
    'new_exact_source_package_observations', 13,
    'manufacturer_current_equivalent_packages', 2,
    'safe_exact_version_barcode_count', 6,
    'reused_gtin_safe_abstention_count', 7,
    'purina_one_formula_count', 240,
    'purina_one_searchable_formula_count', 115,
    'purina_one_formula_gap_count', 125,
    'purina_one_searchable_gain_since_v122', 7,
    'net_searchable_formula_gain_since_v122', 7,
    'net_gap_reduction_since_v122', 5,
    'missing_source_panel', jsonb_build_array(
      'petco-retail-catalog', 'amazon-retail-catalog'
    ),
    'census_artifact',
      'outputs/catalog-market-leaders/'
      || 'brand-coverage-sprint-current-major95-target-purina-one-v124-20260726',
    'sprint_artifact',
      'outputs/catalog-market-leaders/'
      || 'brand-coverage-sprint-current-major95-target-purina-one-v124-20260726-sprint',
