-- Multipacks are not safe exact-formula catalog rows. Even when an official
-- page includes ingredient evidence, the product can represent multiple trays
-- or recipes and should not be scored as one formula.
