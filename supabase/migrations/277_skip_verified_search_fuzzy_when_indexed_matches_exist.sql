-- Avoid paying for the trigram fallback when indexed full-text candidates
-- already satisfy an app search. Fuzzy matching remains available for real
-- typo/no-match recovery, but normal searches stay on the GIN path.
