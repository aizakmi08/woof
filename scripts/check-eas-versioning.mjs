...
if (packageJson.version !== "1.2.2") {
  fail(`package.json version should stay on the audited 1.2.2 release line, got ${packageJson.version}`);
}
...
for (const [source, context, snippets] of [
  [
    ...
    [
      ...
      "build `31`",
      "build version `1.1.1`",
      "production build `54` completed for version `1.2.2`",
      "Remote EAS app version must match",
      "greater than App Store Connect/TestFlight build `54`",
